  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <div class="summary-item">
        ...
        <span class="summary-value">${abonadoTotals.totalPrice}&nbsp;€</span>
      </div>
      <div class="summary-item">
        <span class="summary-label">Descuentos:</span>
        <span class="summary-value discount">-${abonadoTotals.totalDiscount}&nbsp;€</span>
      </div>
      <div class="summary-total">
        <span class="summary-label">Total Neto:</span>
        <span class="summary-value">${abonadoTotals.totalFinal}&nbsp;€</span>
      </div>
    </div>
